...
export function LiveSidebar({ groups, participants, groupId, draft, onGroupChange, onDraftChange }: {
  ...
  return <aside className="live-sidebar" aria-label="Liderança e pote ao vivo">
    ...
    <div className="live-meme-card"><span className="dukoth-emblem-mini"><img src="/dukoth/twitch-banner.webp" alt="Personagem do banner oficial do Dukoth" /></span><div><b>RECADO DA GUILD</b><span>Quem vai dropar a sorte grande?</span></div></div>
